...
import shutil
import types
from pymousegan.models.gans import VanillaGAN


class VanillaGANTester(unittest.TestCase):
    def setUp(self):
    ...
    def test_VanillaGAN_data_aug(self):
        """Tests that VanillaGAN can be trained with data augmentation.
        """
        ...
        gan = VanillaGAN(noise_size=(100,), seq_shape=(100, 3),
                         data_aug=scale_translate_v3, d_opt=d_opt, g_opt=g_opt)
    ...
    def test_VanillaGAN_model_loading_h5(self):
        """Tests the discriminator and generator model loading.
        """
        coords_dt = np.load('../data/coords_dt.npy')
        # Runs one iteration of the model
        seed = 42
        ...
        gan2 = VanillaGAN(noise_size=(100,), seq_shape=(100, 3),
                          d_opt=d_opt, g_opt=g_opt, model_paths=model_paths)
